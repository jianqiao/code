...
int GetColumn(CTXTdecl)
{
  ...
  case SQL_C_SLONG:
    {
      Cell h;
      bld_oint(&h,(Integer)(*(int *)(cur->Data[ColCurNum])));
      return unify(CTXTc op, h);
    }
  case SQL_C_SBIGINT:
    {
      Cell h;
      bld_oint(&h,(Integer)(*(long long *)(cur->Data[ColCurNum])));
      return unify(CTXTc op, h);
    }
  case SQL_C_FLOAT:
#ifndef FAST_FLOATS
...
void ODBCPrepare(CTXTdecl) {
  printf("Hello, this is ODBCPrepare!\n");
}

void ODBCExecute(CTXTdecl) {
  printf("Hello, this is ODBCExecute!\n");
}

void ODBCFree(CTXTdecl) {
  printf("Hello, this is ODBCFree!\n");
}
